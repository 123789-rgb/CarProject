...
<tr>
           <td><%out.println(results.getString(1));%></td>
			<td><%out.println(results.getString(2));%></td>
			 ...
			 <td> <a href="DeleteController?licencePlateNumber=<%=results.getString(7)%>">Delete</a> </td>
             <td><a href="UpdateController?licencePlateNumber=<%=results.getString(7)%>">Update</a></td>
